...
<img src="./docs/readme/preview-generate.svg" alt="AI牛马刷题首页预览" width="360" />

简介：用户直接粘贴学习材料，选择出题模式、反馈方式、题型、难度和题量，一键进入 AI 出题流程。

### 2. 题集沉淀与复盘

<img src="./docs/readme/preview-collection.svg" alt="AI牛马刷题题集页预览" width="360" />

简介：题目会沉淀到题集里，并按 `全部 / 错题 / 掌握` 管理，结合进度、标签和清理能力，帮助用户做持续复盘。

### 3. 个性化配置与题集进化

<img src="./docs/readme/preview-profile.svg" alt="AI牛马刷题个人页预览" width="360" />
